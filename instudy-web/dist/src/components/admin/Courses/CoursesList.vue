            ...
            <v-flex xs12 class="padding elevation-0">
                <v-card class="blue-grey darken-2 white--text ">
                    <v-card-title>
                     ...
                     <v-card-actions>
                        <router-link :to="'courses/create'"> <v-icon>create</v-icon></router-link>                   
                    ...
                    <template slot="headerCell" scope="props">
                        ...
                        <template slot="items" scope="props" >
                             <tr :active="props.selected" @click="showUser(props.item.id)">
                                 ...
                                 <td class="text-xs-center">{{ props.item.age }} course {{ props.item.specialty.name }}</td>
                                 ...
                                 <td class="text-xs-center">{{ moment(props.item.created_at).format("MMM Do YY") }}</td>
                                <td class="text-xs-center">
                                    <span class="group pa-2">
                                     <!-- <v-icon>home</v-icon> -->
                                     <!-- <v-icon>event</v-icon> -->
                                     <router-link :to="`courses/${props.item.id}`"> <v-icon>info</v-icon></router-link> 
                                    </span>
                                </td>
                             </tr> 
                        </template>
